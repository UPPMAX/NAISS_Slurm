...
# Remove any loaded modules and load the ones we need (they recommend Python/3.10.4-env-hpc1-gcc-2022a-eb which can be loaded directly, so in many cases we would use that) 
module purge  > /dev/null 2>&1
module load buildtool-easybuild/4.8.0-hpce082752a2 GCC/13.2.0 
